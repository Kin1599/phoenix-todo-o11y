defmodule TodoTaskManagerWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: TodoTaskManagerWeb.Layouts]

      use Gettext, backend: TodoTaskManagerWeb.Gettext
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {TodoTaskManagerWeb.Layouts, :app}
  ...
  defp html_helpers do
    quote do
      ...
      import Phoenix.HTML
      # Core UI components
      import TodoTaskManagerWeb.CoreComponents
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        statics: TodoTaskManagerWeb.static_paths()
    end
  end
